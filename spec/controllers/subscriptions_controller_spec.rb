...
describe SubscriptionsController do
  ...
  let(:valid_attributes) { { "plan_type" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved subscription as @subscription" do
        ...
        post :create, {:subscription => { "plan_type" => "invalid value" }}, valid_session
        assigns(:subscription).should be_a_new(Subscription)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested subscription" do
        ...
        Subscription.any_instance.should_receive(:update).with({ "plan_type" => "1" })
        put :update, {:id => subscription.to_param, :subscription => { "plan_type" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the subscription as @subscription" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Subscription.any_instance.stub(:save).and_return(false)
        put :update, {:id => subscription.to_param, :subscription => { "plan_type" => "invalid value" }}, valid_session
        assigns(:subscription).should eq(subscription)
      end
